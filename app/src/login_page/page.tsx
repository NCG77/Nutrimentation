    ...
    <div className={styles.page}>
      <div className={styles.left}>
        <div className={styles.card}>
          ...
          <p className={styles.subtitle}>Sign in to continue to Nutrimentation</p>
      ...
      <div className={styles.right}>
        <div className={styles.brand}>
          <span>KNOW ABOUT WHAT YOU CONSUME</span>
          <h1>Nutrimentation: Your AI-Powered Nutrition Assistant</h1>
          <p>
            Nutrimentation analyzes and provides nutrition value of your ready to eat meals, 
